...
static void RegisterGenerated_meos_temporal_bbox_topo(ExtensionLoader &loader) {
    for (auto &type : TemporalTypes::AllTypes()) {
        RegisterSerializedScalarFunction(loader, ScalarFunction("adjacent_bbox", {type, type}, LogicalType::BOOLEAN, Gen_adjacent_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("adjacent", {type, type}, LogicalType::BOOLEAN, Gen_adjacent_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("-|-", {type, type}, LogicalType::BOOLEAN, Gen_adjacent_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("contained_bbox", {type, type}, LogicalType::BOOLEAN, Gen_contained_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {type, type}, LogicalType::BOOLEAN, Gen_contained_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("<@", {type, type}, LogicalType::BOOLEAN, Gen_contained_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("contains_bbox", {type, type}, LogicalType::BOOLEAN, Gen_contains_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {type, type}, LogicalType::BOOLEAN, Gen_contains_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("@>", {type, type}, LogicalType::BOOLEAN, Gen_contains_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("overlaps_bbox", {type, type}, LogicalType::BOOLEAN, Gen_overlaps_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("overlaps", {type, type}, LogicalType::BOOLEAN, Gen_overlaps_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("&&", {type, type}, LogicalType::BOOLEAN, Gen_overlaps_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("same_bbox", {type, type}, LogicalType::BOOLEAN, Gen_same_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("same", {type, type}, LogicalType::BOOLEAN, Gen_same_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("~=", {type, type}, LogicalType::BOOLEAN, Gen_same_temporal_temporal));
    }
    for (auto &type : std::vector<LogicalType>{TgeompointType::tgeompoint(), TgeogpointType::tgeogpoint(), TGeometryTypes::tgeometry(), TGeographyTypes::tgeography()}) {
        RegisterSerializedScalarFunction(loader, ScalarFunction("adjacent_bbox", {type, type}, LogicalType::BOOLEAN, Gen_adjacent_temporal_temporal));
        RegisterSerializedScalarFunction(loader, ScalarFunction("adjacent", {type, type}, LogicalType::BOOLEAN, Gen_adjacent_temporal_temporal));
