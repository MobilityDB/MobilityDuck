...
extern "C" {
    ...
    // acovers_geo_tgeo / acovers_tgeo_geo — see tgeometry_ops.cpp for
    // the rationale; both are linkable from the current vcpkg-shipped
...
#define EA_REG_2_COMMUT(NAME, F_TGEO_GEO, F_TGEO_TGEO) \
    ...
    // Always_eq / ever_eq / always_ne / ever_ne for the geographic
    // tspatial × geometry surface plus the tgeogpoint signatures.
    ...
    {
        const LogicalType TGP = TGeogpointType::TGEOGPOINT();
