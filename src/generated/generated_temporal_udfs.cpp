...
static void RegisterGenerated_meos_cbuffer_conversion(ExtensionLoader &loader) {
    RegisterSerializedScalarFunction(loader, ScalarFunction("tfloat", {TemporalTypes::tfloat()}, TemporalTypes::tfloat(), Gen_tcbuffer_to_tfloat));
    RegisterSerializedScalarFunction(loader, ScalarFunction("::", {TemporalTypes::tfloat()}, TemporalTypes::tfloat(), Gen_tcbuffer_to_tfloat));
    RegisterSerializedScalarFunction(loader, ScalarFunction("tcbuffer", {TGeometryTypes::tgeometry()}, TGeometryTypes::tgeometry(), Gen_tgeometry_to_tcbuffer));
    RegisterSerializedScalarFunction(loader, ScalarFunction("::", {TGeometryTypes::tgeometry()}, TGeometryTypes::tgeometry(), Gen_tgeometry_to_tcbuffer));
}
...
static void RegisterGenerated_meos_geo_bbox_topo(ExtensionLoader &loader) {
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {TgeompointType::tgeompoint(), TgeompointType::tgeompoint()}, LogicalType::BOOLEAN, Gen_contained_tspatial_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {TgeogpointType::tgeogpoint(), TgeogpointType::tgeogpoint()}, LogicalType::BOOLEAN, Gen_contained_tspatial_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {TGeometryTypes::tgeometry(), TGeometryTypes::tgeometry()}, LogicalType::BOOLEAN, Gen_contained_tspatial_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {TGeographyTypes::tgeography(), TGeographyTypes::tgeography()}, LogicalType::BOOLEAN, Gen_contained_tspatial_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {TgeompointType::tgeompoint(), TgeompointType::tgeompoint()}, LogicalType::BOOLEAN, Gen_contains_tspatial_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {TgeogpointType::tgeogpoint(), TgeogpointType::tgeogpoint()}, LogicalType::BOOLEAN, Gen_contains_tspatial_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {TGeometryTypes::tgeometry(), TGeometryTypes::tgeometry()}, LogicalType::BOOLEAN, Gen_contains_tspatial_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {TGeographyTypes::tgeography(), TGeographyTypes::tgeography()}, LogicalType::BOOLEAN, Gen_contains_tspatial_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {StboxType::stbox(), TgeompointType::tgeompoint()}, LogicalType::BOOLEAN, Gen_contained_stbox_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {StboxType::stbox(), TgeogpointType::tgeogpoint()}, LogicalType::BOOLEAN, Gen_contained_stbox_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {StboxType::stbox(), TGeometryTypes::tgeometry()}, LogicalType::BOOLEAN, Gen_contained_stbox_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {StboxType::stbox(), TGeographyTypes::tgeography()}, LogicalType::BOOLEAN, Gen_contained_stbox_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {TgeompointType::tgeompoint(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_contained_tspatial_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {TgeogpointType::tgeogpoint(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_contained_tspatial_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {TGeometryTypes::tgeometry(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_contained_tspatial_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contains", {TGeographyTypes::tgeography(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_contained_tspatial_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {StboxType::stbox(), TgeompointType::tgeompoint()}, LogicalType::BOOLEAN, Gen_contains_stbox_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {StboxType::stbox(), TgeogpointType::tgeogpoint()}, LogicalType::BOOLEAN, Gen_contains_stbox_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {StboxType::stbox(), TGeometryTypes::tgeometry()}, LogicalType::BOOLEAN, Gen_contains_stbox_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {StboxType::stbox(), TGeographyTypes::tgeography()}, LogicalType::BOOLEAN, Gen_contains_stbox_tspatial));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {TgeompointType::tgeompoint(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_contains_tspatial_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {TgeogpointType::tgeogpoint(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_contains_tspatial_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {TGeometryTypes::tgeometry(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_contains_tspatial_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("contained", {TGeographyTypes::tgeography(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_contains_tspatial_stbox));
...
static void RegisterGenerated_meos_geo_box_pos(ExtensionLoader &loader) {
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("right", {StboxType::stbox(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_left_stbox_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("overright", {StboxType::stbox(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_overleft_stbox_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("overleft", {StboxType::stbox(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_overright_stbox_stbox));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("left", {StboxType::stbox(), StboxType::stbox()}, LogicalType::BOOLEAN, Gen_right_stbox_stbox));
...
static void RegisterGenerated_meos_h3_conversion(ExtensionLoader &loader) {
    RegisterSerializedScalarFunction(loader, ScalarFunction("th3index", {TemporalTypes::tbigint()}, TemporalTypes::tbigint(), Gen_tbigint_to_th3index));
    RegisterSerializedScalarFunction(loader, ScalarFunction("::", {TemporalTypes::tbigint()}, TemporalTypes::tbigint(), Gen_tbigint_to_th3index));
    RegisterSerializedScalarFunction(loader, ScalarFunction("tbigint", {TemporalTypes::tbigint()}, TemporalTypes::tbigint(), Gen_th3index_to_tbigint));
...
static void RegisterGenerated_meos_h3_latlng(ExtensionLoader &loader) {
    RegisterSerializedScalarFunction(loader, ScalarFunction("th3index", {TgeogpointType::tgeogpoint(), LogicalType::INTEGER}, TgeogpointType::tgeogpoint(), Gen_tgeogpoint_to_th3index));
    RegisterSerializedScalarFunction(loader, ScalarFunction("th3index", {TgeompointType::tgeompoint(), LogicalType::INTEGER}, TgeompointType::tgeompoint(), Gen_tgeompoint_to_th3index));
}

static void RegisterGenerated_meos_json_conversion(ExtensionLoader &loader) {
    RegisterSerializedScalarFunction(loader, ScalarFunction("ttext", {TemporalTypes::ttext()}, TemporalTypes::ttext(), Gen_tjsonb_to_ttext));
    RegisterSerializedScalarFunction(loader, ScalarFunction("::", {TemporalTypes::ttext()}, TemporalTypes::ttext(), Gen_tjsonb_to_ttext));
    RegisterSerializedScalarFunction(loader, ScalarFunction("tjsonb", {TemporalTypes::ttext()}, TemporalTypes::ttext(), Gen_ttext_to_tjsonb));
    RegisterSerializedScalarFunction(loader, ScalarFunction("::", {TemporalTypes::ttext()}, TemporalTypes::ttext(), Gen_ttext_to_tjsonb));
}

static void RegisterGenerated_meos_npoint_conversion(ExtensionLoader &loader) {
    RegisterSerializedScalarFunction(loader, ScalarFunction("tnpoint", {TgeompointType::tgeompoint()}, TgeompointType::tgeompoint(), Gen_tgeompoint_to_tnpoint));
    RegisterSerializedScalarFunction(loader, ScalarFunction("::", {TgeompointType::tgeompoint()}, TgeompointType::tgeompoint(), Gen_tgeompoint_to_tnpoint));
}
...
static void RegisterGenerated_meos_setspan_pos(ExtensionLoader &loader) {
    for (auto &type : SetTypes::AllTypes()) {
        RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {type, type}, LogicalType::BOOLEAN, Gen_left_set_set));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {type, type}, LogicalType::BOOLEAN, Gen_overleft_set_set));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {type, type}, LogicalType::BOOLEAN, Gen_overright_set_set));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {type, type}, LogicalType::BOOLEAN, Gen_right_set_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {LogicalType::DATE, SetTypes::dateset()}, LogicalType::BOOLEAN, Gen_after_date_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {SetTypes::dateset(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_after_set_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {SetTypes::tstzset(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_after_set_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {LogicalType::TIMESTAMP_TZ, SetTypes::tstzset()}, LogicalType::BOOLEAN, Gen_after_timestamptz_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {LogicalType::DATE, SetTypes::dateset()}, LogicalType::BOOLEAN, Gen_before_date_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {SetTypes::dateset(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_before_set_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {SetTypes::tstzset(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_before_set_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {LogicalType::TIMESTAMP_TZ, SetTypes::tstzset()}, LogicalType::BOOLEAN, Gen_before_timestamptz_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {LogicalType::BIGINT, SetTypes::bigintset()}, LogicalType::BOOLEAN, Gen_left_bigint_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {LogicalType::DOUBLE, SetTypes::floatset()}, LogicalType::BOOLEAN, Gen_left_float_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {LogicalType::INTEGER, SetTypes::intset()}, LogicalType::BOOLEAN, Gen_left_int_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {SetTypes::bigintset(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_left_set_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {SetTypes::floatset(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_left_set_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {SetTypes::intset(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_left_set_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {SetTypes::textset(), LogicalType::VARCHAR}, LogicalType::BOOLEAN, Gen_left_set_text));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_left", {LogicalType::VARCHAR, SetTypes::textset()}, LogicalType::BOOLEAN, Gen_left_text_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {LogicalType::DATE, SetTypes::dateset()}, LogicalType::BOOLEAN, Gen_overafter_date_set));
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {SetTypes::dateset(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_overafter_set_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {SetTypes::tstzset(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_overafter_set_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {LogicalType::TIMESTAMP_TZ, SetTypes::tstzset()}, LogicalType::BOOLEAN, Gen_overafter_timestamptz_set));
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {LogicalType::DATE, SetTypes::dateset()}, LogicalType::BOOLEAN, Gen_overbefore_date_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {SetTypes::dateset(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_overbefore_set_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {SetTypes::tstzset(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_overbefore_set_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {LogicalType::TIMESTAMP_TZ, SetTypes::tstzset()}, LogicalType::BOOLEAN, Gen_overbefore_timestamptz_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {LogicalType::BIGINT, SetTypes::bigintset()}, LogicalType::BOOLEAN, Gen_overleft_bigint_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {LogicalType::DOUBLE, SetTypes::floatset()}, LogicalType::BOOLEAN, Gen_overleft_float_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {SetTypes::bigintset(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_overleft_set_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {SetTypes::floatset(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_overleft_set_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {SetTypes::intset(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_overleft_set_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {SetTypes::textset(), LogicalType::VARCHAR}, LogicalType::BOOLEAN, Gen_overleft_set_text));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overleft", {LogicalType::VARCHAR, SetTypes::textset()}, LogicalType::BOOLEAN, Gen_overleft_text_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {LogicalType::BIGINT, SetTypes::bigintset()}, LogicalType::BOOLEAN, Gen_overright_bigint_set));
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {LogicalType::DOUBLE, SetTypes::floatset()}, LogicalType::BOOLEAN, Gen_overright_float_set));
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {LogicalType::INTEGER, SetTypes::intset()}, LogicalType::BOOLEAN, Gen_overright_int_set));
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {SetTypes::bigintset(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_overright_set_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {SetTypes::floatset(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_overright_set_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {SetTypes::intset(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_overright_set_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {SetTypes::textset(), LogicalType::VARCHAR}, LogicalType::BOOLEAN, Gen_overright_set_text));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_overright", {LogicalType::VARCHAR, SetTypes::textset()}, LogicalType::BOOLEAN, Gen_overright_text_set));
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {LogicalType::BIGINT, SetTypes::bigintset()}, LogicalType::BOOLEAN, Gen_right_bigint_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {LogicalType::DOUBLE, SetTypes::floatset()}, LogicalType::BOOLEAN, Gen_right_float_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {LogicalType::INTEGER, SetTypes::intset()}, LogicalType::BOOLEAN, Gen_right_int_set));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {SetTypes::bigintset(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_right_set_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {SetTypes::floatset(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_right_set_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {SetTypes::intset(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_right_set_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {SetTypes::textset(), LogicalType::VARCHAR}, LogicalType::BOOLEAN, Gen_right_set_text));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("set_right", {LogicalType::VARCHAR, SetTypes::textset()}, LogicalType::BOOLEAN, Gen_right_text_set));
    ...
    for (auto &type : SpanTypes::AllTypes()) {
        RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {type, type}, LogicalType::BOOLEAN, Gen_left_span_span));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {type, type}, LogicalType::BOOLEAN, Gen_overleft_span_span));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {type, type}, LogicalType::BOOLEAN, Gen_overright_span_span));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {type, type}, LogicalType::BOOLEAN, Gen_right_span_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::DATE, SpanTypes::datespan()}, LogicalType::BOOLEAN, Gen_after_date_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpanTypes::datespan(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_after_span_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpanTypes::tstzspan(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_after_span_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::TIMESTAMP_TZ, SpanTypes::tstzspan()}, LogicalType::BOOLEAN, Gen_after_timestamptz_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::DATE, SpanTypes::datespan()}, LogicalType::BOOLEAN, Gen_before_date_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpanTypes::datespan(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_before_span_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::TIMESTAMP_TZ, SpanTypes::tstzspan()}, LogicalType::BOOLEAN, Gen_before_timestamptz_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::BIGINT, SpanTypes::bigintspan()}, LogicalType::BOOLEAN, Gen_left_bigint_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::DOUBLE, SpanTypes::floatspan()}, LogicalType::BOOLEAN, Gen_left_float_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::INTEGER, SpanTypes::intspan()}, LogicalType::BOOLEAN, Gen_left_int_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpanTypes::bigintspan(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_left_span_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpanTypes::floatspan(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_left_span_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpanTypes::intspan(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_left_span_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::DATE, SpanTypes::datespan()}, LogicalType::BOOLEAN, Gen_overafter_date_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpanTypes::datespan(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_overafter_span_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpanTypes::tstzspan(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_overafter_span_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::TIMESTAMP_TZ, SpanTypes::tstzspan()}, LogicalType::BOOLEAN, Gen_overafter_timestamptz_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::DATE, SpanTypes::datespan()}, LogicalType::BOOLEAN, Gen_overbefore_date_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpanTypes::datespan(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_overbefore_span_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpanTypes::tstzspan(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_overbefore_span_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::TIMESTAMP_TZ, SpanTypes::tstzspan()}, LogicalType::BOOLEAN, Gen_overbefore_timestamptz_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::BIGINT, SpanTypes::bigintspan()}, LogicalType::BOOLEAN, Gen_overleft_bigint_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::DOUBLE, SpanTypes::floatspan()}, LogicalType::BOOLEAN, Gen_overleft_float_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::INTEGER, SpanTypes::intspan()}, LogicalType::BOOLEAN, Gen_overleft_int_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpanTypes::bigintspan(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_overleft_span_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpanTypes::floatspan(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_overleft_span_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpanTypes::intspan(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_overleft_span_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::BIGINT, SpanTypes::bigintspan()}, LogicalType::BOOLEAN, Gen_overright_bigint_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::DOUBLE, SpanTypes::floatspan()}, LogicalType::BOOLEAN, Gen_overright_float_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::INTEGER, SpanTypes::intspan()}, LogicalType::BOOLEAN, Gen_overright_int_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpanTypes::bigintspan(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_overright_span_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpanTypes::floatspan(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_overright_span_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpanTypes::intspan(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_overright_span_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::BIGINT, SpanTypes::bigintspan()}, LogicalType::BOOLEAN, Gen_right_bigint_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::DOUBLE, SpanTypes::floatspan()}, LogicalType::BOOLEAN, Gen_right_float_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::INTEGER, SpanTypes::intspan()}, LogicalType::BOOLEAN, Gen_right_int_span));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpanTypes::bigintspan(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_right_span_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpanTypes::floatspan(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_right_span_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpanTypes::intspan(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_right_span_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::DATE, SpansetTypes::datespanset()}, LogicalType::BOOLEAN, Gen_after_date_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpansetTypes::datespanset(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_after_spanset_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpansetTypes::tstzspanset(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_after_spanset_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::TIMESTAMP_TZ, SpansetTypes::tstzspanset()}, LogicalType::BOOLEAN, Gen_after_timestamptz_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::DATE, SpansetTypes::datespanset()}, LogicalType::BOOLEAN, Gen_before_date_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpansetTypes::datespanset(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_before_spanset_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpansetTypes::tstzspanset(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_before_spanset_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::TIMESTAMP_TZ, SpansetTypes::tstzspanset()}, LogicalType::BOOLEAN, Gen_before_timestamptz_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::BIGINT, SpansetTypes::bigintspanset()}, LogicalType::BOOLEAN, Gen_left_bigint_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::DOUBLE, SpansetTypes::floatspanset()}, LogicalType::BOOLEAN, Gen_left_float_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {LogicalType::INTEGER, SpansetTypes::intspanset()}, LogicalType::BOOLEAN, Gen_left_int_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpansetTypes::bigintspanset(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_left_spanset_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpansetTypes::floatspanset(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_left_spanset_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {SpansetTypes::intspanset(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_left_spanset_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::DATE, SpansetTypes::datespanset()}, LogicalType::BOOLEAN, Gen_overafter_date_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpansetTypes::datespanset(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_overafter_spanset_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpansetTypes::tstzspanset(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_overafter_spanset_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::TIMESTAMP_TZ, SpansetTypes::tstzspanset()}, LogicalType::BOOLEAN, Gen_overafter_timestamptz_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::DATE, SpansetTypes::datespanset()}, LogicalType::BOOLEAN, Gen_overbefore_date_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpansetTypes::datespanset(), LogicalType::DATE}, LogicalType::BOOLEAN, Gen_overbefore_spanset_date));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpansetTypes::tstzspanset(), LogicalType::TIMESTAMP_TZ}, LogicalType::BOOLEAN, Gen_overbefore_spanset_timestamptz));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::TIMESTAMP_TZ, SpansetTypes::tstzspanset()}, LogicalType::BOOLEAN, Gen_overbefore_timestamptz_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::BIGINT, SpansetTypes::bigintspanset()}, LogicalType::BOOLEAN, Gen_overleft_bigint_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::DOUBLE, SpansetTypes::floatspanset()}, LogicalType::BOOLEAN, Gen_overleft_float_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {LogicalType::INTEGER, SpansetTypes::intspanset()}, LogicalType::BOOLEAN, Gen_overleft_int_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpansetTypes::bigintspanset(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_overleft_spanset_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpansetTypes::floatspanset(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_overleft_spanset_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {SpansetTypes::intspanset(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_overleft_spanset_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::BIGINT, SpansetTypes::bigintspanset()}, LogicalType::BOOLEAN, Gen_overright_bigint_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::DOUBLE, SpansetTypes::floatspanset()}, LogicalType::BOOLEAN, Gen_overright_float_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {LogicalType::INTEGER, SpansetTypes::intspanset()}, LogicalType::BOOLEAN, Gen_overright_int_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpansetTypes::bigintspanset(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_overright_spanset_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpansetTypes::floatspanset(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_overright_spanset_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {SpansetTypes::intspanset(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_overright_spanset_int));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::BIGINT, SpansetTypes::bigintspanset()}, LogicalType::BOOLEAN, Gen_right_bigint_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::DOUBLE, SpansetTypes::floatspanset()}, LogicalType::BOOLEAN, Gen_right_float_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {LogicalType::INTEGER, SpansetTypes::intspanset()}, LogicalType::BOOLEAN, Gen_right_int_spanset));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpansetTypes::bigintspanset(), LogicalType::BIGINT}, LogicalType::BOOLEAN, Gen_right_spanset_bigint));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpansetTypes::floatspanset(), LogicalType::DOUBLE}, LogicalType::BOOLEAN, Gen_right_spanset_float));
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {SpansetTypes::intspanset(), LogicalType::INTEGER}, LogicalType::BOOLEAN, Gen_right_spanset_int));
    ...
    for (auto &type : SpansetTypes::AllTypes()) {
        RegisterSerializedScalarFunction(loader, ScalarFunction("span_left", {type, type}, LogicalType::BOOLEAN, Gen_left_spanset_spanset));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("span_overleft", {type, type}, LogicalType::BOOLEAN, Gen_overleft_spanset_spanset));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("span_overright", {type, type}, LogicalType::BOOLEAN, Gen_overright_spanset_spanset));
        ...
        RegisterSerializedScalarFunction(loader, ScalarFunction("span_right", {type, type}, LogicalType::BOOLEAN, Gen_right_spanset_spanset));
...
static void RegisterGenerated_meos_temporal_math(ExtensionLoader &loader) {
    ...
    RegisterSerializedScalarFunction(loader, ScalarFunction("ln", {TemporalTypes::tfloat()}, TemporalTypes::tfloat(), Gen_tfloat_exp));
    RegisterSerializedScalarFunction(loader, ScalarFunction("ln", {TemporalTypes::tfloat()}, TemporalTypes::tfloat(), Gen_tfloat_ln));
    RegisterSerializedScalarFunction(loader, ScalarFunction("ln", {TemporalTypes::tfloat()}, TemporalTypes::tfloat(), Gen_tfloat_log10));
