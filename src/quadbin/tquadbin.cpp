...
void QuadbinTypes::RegisterCastFunctions(ExtensionLoader &loader) {
    loader.RegisterCastFunction(LogicalType::VARCHAR, QUADBIN(),
        QuadbinFunctions::Quadbin_in_cast);
    loader.RegisterCastFunction(QUADBIN(), LogicalType::VARCHAR,
        QuadbinFunctions::Quadbin_out_cast);
    loader.RegisterCastFunction(LogicalType::VARCHAR, TQUADBIN(),
        QuadbinFunctions::Tquadbin_in_cast);
    loader.RegisterCastFunction(TQUADBIN(), LogicalType::VARCHAR,
