...
void RegisterGeneratedTemporalUdfs(ExtensionLoader &loader) {
    ...
    RegisterGenerated_meos_pointcloud_base_comp(loader);
    ...
    RegisterGenerated_meos_quadbin_set_inout(loader);
    ...
    RegisterGenerated_meos_s2cell_base_comp(loader);
    ...
    RegisterGenerated_meos_s2cell_set_inout(loader);
