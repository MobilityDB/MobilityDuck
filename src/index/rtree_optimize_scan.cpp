        ...
        for (auto &filter_pair : get.table_filters.filters) {
            ...
            MobilityDuckScanIndexes(table_info.GetIndexes(), [&](Index &index) -> bool {
                ...
                bind_data = make_uniq<TRTreeIndexScanBindData>(
                    duck_table, rtree_index, 1000, query_box, box_size, function_name, query_on_left);
                return true;
            });
    ...
    static bool TryOptimizeLogicalTopN(ClientContext &context, unique_ptr<LogicalOperator> &plan) {
        ...
        MobilityDuckScanIndexes(table_info.GetIndexes(), [&](Index &index) -> bool {
            ...
            bind_data = make_uniq<TRTreeIndexScanBindData>(
                ...
                TRTreeIndexScanBindData::NN_OPERATION, false);
            return true;
        });
...
void TRTreeModule::RegisterScanOptimizer(ExtensionLoader &loader) {
    MobilityDuckRegisterOptimizer(loader.GetDatabaseInstance().config, TRTreeIndexScanOptimizer());
}
