...
static void Tgeo_constructor(DataChunk &args, ExpressionState &state, Vector &result) {
...
static void Tgeoinst_constructor(DataChunk &args, ExpressionState &state, Vector &result) {
    auto count = args.size();
...
static void Tgeometry_sequence_from_tstzspan(DataChunk &args, ExpressionState &state, Vector &result) {
...
static void Tgeometry_sequence_constructor(DataChunk &args, ExpressionState &state, Vector &result) {
    // Default values
    const char* default_interp = "step";
