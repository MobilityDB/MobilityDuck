...
void TGeogpointType::RegisterScalarFunctions(ExtensionLoader &loader) {
    ...
    RegisterMeosFunction(loader, tgeogpoint_function);
    ...
    RegisterMeosFunction(loader, tgeogpoint_from_timestamp_function);
    ...
    RegisterMeosFunction(loader, tgeogpoint_from_tstzspan_function);
    ...
    RegisterMeosFunction(loader, tgeogpoint_from_tstzspan_default);
    ...
    RegisterMeosFunction(loader, tgeogpointseqarr_1param);
    ...
    RegisterMeosFunction(loader, tgeogpointseqarr_2params);
    ...
    RegisterMeosFunction(loader, tgeogpointseqarr_3params);
    ...
    RegisterMeosFunction(loader, tgeogpointseqarr_4params);
    ...
    RegisterMeosFunction(loader, tgeogpoint_to_tinstant_function);
    ...
    RegisterMeosFunction(loader, tempSubtype_function);
    ...
    RegisterMeosFunction(loader, interp_function);
    ...
    RegisterMeosFunction(loader, tgeogpoint_start_value_function);
    ...
    RegisterMeosFunction(loader, tgeogpoint_end_value_function);
    ...
    RegisterMeosFunction(loader, startInstant_function);
    ...
    RegisterMeosFunction(loader, endInstant_function);
    ...
    RegisterMeosFunction(loader, instantN_function);
    ...
    RegisterMeosFunction(loader, tgeogpoint_gettimestamptz_function);
